  ...
  <div class="container mx-auto px-4 py-16">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-12">
      ...
      <div class="team-card relative overflow-hidden group">
        <div class="team-card-inner bg-indigo-900/80 rounded-lg p-8 flex flex-col md:flex-row items-center gap-8 backdrop-blur-sm border border-indigo-600/50 transition-all duration-300">
          <div class="team-image-wrapper">
            <img class="team-image w-40 h-40 rounded-lg object-cover border-4 border-indigo-500" src="~/assets/images/team/josh_dunn_ghibli.png" alt="John Michael Francis Photo">
          </div>
      ...
      <div class="team-card relative overflow-hidden group">
        <div class="team-card-inner bg-indigo-900/80 rounded-lg p-8 flex flex-col md:flex-row items-center gap-8 backdrop-blur-sm border border-indigo-600/50 transition-all duration-300">
          <div class="team-image-wrapper">
            <img class="team-image w-40 h-40 rounded-lg object-cover border-4 border-indigo-500" src="~/assets/images/team/juan_pablo_perez_calva_ghibli.png" alt="Juan Pablo Perez Calva Photo">
          </div>
          <div class="team-content flex-1">
            <h3 class="text-2xl font-semibold mb-2 text-white">Juan Pablo Perez Calva</h3>
            <p class="text-indigo-300 mb-4">Founder & CEO / Fintech / Payments&Lending / Financial Products</p>
            <p class="text-gray-300 text-sm mb-4 line-clamp-4 group-hover:line-clamp-none transition-all duration-300">
              Financial Inclusion / Healthtech / Latitud Fellow
            </p>
            <div class="flex space-x-4 mt-2">
              <a href="https://www.linkedin.com/in/juan-pablo-perez-calva-7773719b/" target="_blank" rel="noopener noreferrer" class="text-indigo-400 hover:text-indigo-200 transition-colors duration-200">
                <span class="sr-only">LinkedIn</span>
                <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path fill-rule="evenodd" d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z" clip-rule="evenodd"></path></svg>
              </a>
            </div>
      ...
      <!-- Team Member Card - Juan Carlos Rodriguez Paniagua -->
      <div class="team-card relative overflow-hidden group">
        <div class="team-card-inner bg-indigo-900/80 rounded-lg p-8 flex flex-col md:flex-row items-center gap-8 backdrop-blur-sm border border-indigo-600/50 transition-all duration-300">
          <div class="team-image-wrapper">
            <img class="team-image w-40 h-40 rounded-lg object-cover border-4 border-indigo-500" src="~/assets/images/team/juan_rodriguez_ghibli.png" alt="Juan Carlos Rodriguez Paniagua Photo">
          </div>
          <div class="team-content flex-1">
            <h3 class="text-2xl font-semibold mb-2 text-white">Juan Carlos Rodriguez Paniagua</h3>
            <p class="text-indigo-300 mb-4">Homeland Cloud Software</p>
            <p class="text-gray-300 text-sm mb-4 line-clamp-4 group-hover:line-clamp-none transition-all duration-300">
              I have been in information technologies for more than 20 years. We have created solutions…
            </p>
            <div class="flex space-x-4 mt-2">
              <a href="https://www.linkedin.com/in/jcrod/" target="_blank" rel="noopener noreferrer" class="text-indigo-400 hover:text-indigo-200 transition-colors duration-200">
                <span class="sr-only">LinkedIn</span>
                <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path fill-rule="evenodd" d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z" clip-rule="evenodd"></path></svg>
              </a>
            </div>
      ...
      <!-- Team Member Card - Kenny -->
      <div class="team-card relative overflow-hidden group">
        <div class="team-card-inner bg-indigo-900/80 rounded-lg p-8 flex flex-col md:flex-row items-center gap-8 backdrop-blur-sm border border-indigo-600/50 transition-all duration-300">
          <div class="team-image-wrapper">
            <img class="team-image w-40 h-40 rounded-lg object-cover border-4 border-indigo-500" src="~/assets/images/team/blain.png" alt="Kenny Photo">
          </div>
          <div class="team-content flex-1">
            <h3 class="text-2xl font-semibold mb-2 text-white">Kenny</h3>
            <p class="text-indigo-300 mb-4">Developer</p>
            <p class="text-gray-300 text-sm mb-4 line-clamp-4 group-hover:line-clamp-none transition-all duration-300">
              With 20+ years of experience, Kenny serves in technical leadership across several organizations. He's a proud active contributor to the open source community. He possesses a diverse range of skills from CSS to DevOps to expert AI prompting. He strives to create value for companies that change the world.
            </p>
            <div class="flex space-x-4 mt-2">
              <a href="https://github.com/web-mech" target="_blank" rel="noopener noreferrer" class="text-indigo-400 hover:text-indigo-200 transition-colors duration-200">
...
useHead({
  title: 'Our Team - S3MT',
  meta: [
    { name: 'description', content: 'Meet the dedicated team behind S3MT.' }
  ]
})
</script>
