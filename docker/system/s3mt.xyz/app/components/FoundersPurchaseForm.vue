<template>
  <div id="invest" class="relative mb-8 animate__animated animate__fadeIn animate__delay-3s">
    ...
    <div class="relative bg-gray-800/80 backdrop-blur-sm rounded-xl border border-gray-700/50 overflow-hidden shadow-xl">
      ...
      <div v-if="!connected" class="p-6 text-center">
        <div class="bg-indigo-900/30 border border-indigo-700/50 rounded-lg p-6 shadow-lg mb-4">
          ...
          <h4 class="text-xl font-semibold text-white mb-2">Connect Your Wallet</h4>
          <p class="text-gray-300 mb-4">Please connect your Solana wallet to purchase S3MT tokens.</p>
